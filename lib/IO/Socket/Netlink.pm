...
=head2 $class->register_protocol( $proto )
...
=head2 $sock = IO::Socket::Netlink->new( %args )
...
=head2 $msg = $sock->new_request( %args )
...
=head2 $sock->recv_nlmsg( $message, $maxlen )
...
=head2 $sock->recv_nlmsgs( \@messages, $maxlen )
